...
import { Card, CardContent, CardMedia, Typography, IconButton, Box, CircularProgress, Collapse, List, ListItem, ListItemText, Chip, Avatar, Tooltip, Badge, Rating, Paper, ImageList, ImageListItem, Button, CardActions, Alert, ThemeProvider, createTheme } from '@mui/material';
...
// Create a consistent theme for all players
